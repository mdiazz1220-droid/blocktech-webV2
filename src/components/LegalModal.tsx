      ...
      >
          ...
          {activeTab === 'terms' && (
            <div id="terms-content" className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <p>
                  blockTech es operado por [Nombre o Razón Social], identificado con [NIT / Cédula de Ciudadanía], con domicilio en Cali, Valle del Cauca, Colombia. Canal de contacto: WhatsApp +57 316 0424062 y correo [correo@blocktechcol.com].
                </p>
              </section>
          ...
          {activeTab === 'privacy' && (
            <div id="privacy-content" className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <p>
                  [Nombre o Razón Social] (blockTech), identificado con [NIT / Cédula de Ciudadanía], domiciliado en Cali, Valle del Cauca, Colombia, es el Responsable del tratamiento de los datos personales recolectados a través de este sitio. Contacto: [correo@blocktechcol.com].
                </p>
              </section>
              ...
              <section id="eliminacion-de-datos" className="bg-amber-50/80 p-5 rounded-2xl border border-amber-200 space-y-3">
                ...
                <p className="text-zinc-700">
                  Las solicitudes para conocer, actualizar, rectificar o solicitar la <strong>supresión y eliminación de datos</strong> se pueden enviar a <strong className="text-black font-mono">[correo@blocktechcol.com]</strong> o por WhatsApp al <strong className="text-black font-mono">+57 316 0424062</strong>, indicando el derecho que desea ejercer. Se atenderán dentro de los plazos que establece la ley (máximo quince días hábiles según el artículo 15 de la Ley 1581 de 2012).
                </p>
              </section>
          ...
          {activeTab === 'cookies' && (
            <div id="cookies-content" className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <p>
                  Para preguntas sobre esta política, escribe a <strong className="text-black font-mono">[correo@blocktechcol.com]</strong> o por WhatsApp al <strong className="text-black font-mono">+57 316 0424062</strong>.
                </p>
              </section>
            </div>
          )}
        ...
        <div className="px-6 py-4 border-t border-[#E7E7E4] bg-[#F7F7F5] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-500">
          <div className="flex items-center gap-2">
            ...
            <span>Consultas: <span className="text-black font-semibold">[correo@blocktechcol.com]</span></span>
          </div>
          <button
            onClick={onClose}
