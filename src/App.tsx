        ...
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6 text-xs sm:text-sm text-zinc-600 font-medium">
            ...
            <button
              ...
              className="hover:text-black transition-colors cursor-pointer bg-transparent border-none p-0 text-xs sm:text-sm text-zinc-600 font-medium"
            >
              Términos
            </button>
            <button
            ...
            <button
              ...
              onClick={() => setLegalModalState({ isOpen: true, tab: 'cookies' })}
              className="hover:text-black transition-colors cursor-pointer bg-transparent border-none p-0 text-xs sm:text-sm text-zinc-600 font-medium"
            >
              Cookies
            </button>
        ...
        {showContact && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-sm text-zinc-500 mb-6">Déjanos tu mensaje y nos pondremos en contacto contigo a la brevedad.</p>
        ...
        {showContactSales && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-sm text-zinc-500 mb-6">Modelos de voz empresariales a medida e infraestructura dedicada.</p>
